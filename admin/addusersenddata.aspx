<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="addusersenddata.aspx.vb" Inherits="virtual_library.WebForm2" %>
...
&nbsp;<table class="style1">
        <tr>
            ...
            <td class="style2">
                    ...
                    ForeColor="#CC6600" ID="Label3"></asp:Label>
        ...
        <tr>
            ...
            <td class="style36">
                <asp:Button ID="Button3" runat="server" BackColor="#CCCCCC" Font-Bold="True" 
                    Font-Size="Small" ForeColor="#000066" Text="View Book" Width="127px" 
        ...
        <tr height="50">
            ...
            <td class="style2">
                <asp:Button ID="Button2" runat="server" BackColor="#CCCCCC" Font-Bold="True" 
                    Font-Size="Small" ForeColor="#000066" Text="CANCEL" Width="127px" 
                    style="height: 30px;    border-radius: 3px;" />
                <br />
            </td>
            <td class="style6">
